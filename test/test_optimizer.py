...
def mock_configuration_object(mock_optimizer_configuration):
    ...
    mock_configuration.optimizer_type = mock_optimizer_configuration['optimizer_type']
    mock_configuration.learning_rate = mock_optimizer_configuration['learning_rate']
